-- Paktay V1: esquema base.
--
-- Es el esquema real de la base de pruebas el 2026-09-23, sacado con
-- pg_dump --schema-only --no-owner --no-privileges (IALogs/logs/2026-09-23_1108-dia2).
-- Sustituye a los 20 archivos de database/ montados en docker-entrypoint-initdb.d,
-- que ya no levantaban una base desde cero, y a las migraciones Flyway V1-V5 de un
-- esquema anterior. En bases existentes Flyway lo marca como baseline y no lo ejecuta.
-- No se edita: cualquier cambio va en una migración nueva.
